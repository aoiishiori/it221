...
public class BorrowRequestDAO {
    ...
    public int submitRequest(String requesterId, String itemBarcodes,
        ...
        if (requesterId == null || requesterId.trim().isEmpty()) return -1;
        if (itemBarcodes == null || itemBarcodes.trim().isEmpty()) return -1;
    ...
    public int approveRequest(int borrowReqId, String custodianId,
        ...
        String[] parts = req.itemBarcodes.split(",");
        List<String> barcodes = new ArrayList<>();
        for (String part : parts) {
            String trimmed = part.trim();
            if (!trimmed.equals("")) barcodes.add(trimmed);
        }
