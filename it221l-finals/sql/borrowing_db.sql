...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 12, 2026 at 12:31 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_mark_overdue_transactions` ()   BEGIN
    ...
    WHERE transaction_status = 'BORROWED' AND expected_return < CURDATE();
END$$
...
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_count_active_borrows` (`p_person_id` VARCHAR(20)) RETURNS INT DETERMINISTIC BEGIN
    ...
    WHERE borrower_id = p_person_id AND transaction_status IN ('BORROWED', 'OVERDUE');
    RETURN active_count;
END$$
...
(4, 'Python Training Workshop', 'TRAINING', '2026-04-20', 'CIS Lab 2', '2021-00005', 'FAC-002', 'PENDING', 'Needs 10 laptops'),
...
(4, '2021-00003', 'STAFF-001', 'IT221L-A', NULL, '2026-04-03 08:00:00', '2026-04-03', NULL, NULL, 'OVERDUE'),
(5, '2021-00006', 'STAFF-001', 'IT221L-B', NULL, '2026-04-05 09:00:00', '2026-04-05', NULL, NULL, 'BORROWED'),
(6, 'FAC-002', 'STAFF-001', NULL, 3, '2026-04-08 08:30:00', '2026-04-08', NULL, NULL, 'BORROWED'),
(7, '2021-00001', 'STAFF-001', NULL, 2, '2026-04-07 09:00:00', '2026-04-10', NULL, NULL, 'BORROWED');
...
INSERT INTO `overdue_report` (`transaction_id`, `first_name`, `last_name`, `item_name`, `expected_return`, `transaction_status`) VALUES
(4, 'Ana', 'Garcia', 'Laptop', '2026-04-03', 'RETURNED_WITH_ISSUE'),
(4, 'Ana', 'Garcia', 'Ethernet Cable', '2026-04-03', 'RETURNED_WITH_ISSUE'),
(5, 'Rico', 'Torres', 'USB Hub', '2026-04-05', 'BORROWED'),
(6, 'Elena', 'Castillo', 'HDMI Cable', '2026-04-08', 'BORROWED'),
(6, 'Elena', 'Castillo', 'USB Hub', '2026-04-08', 'BORROWED'),
(7, 'Maria', 'Santos', 'Laptop', '2026-04-10', 'BORROWED'),
(7, 'Maria', 'Santos', 'Keyboard', '2026-04-10', 'BORROWED');
...
(2, 'STAFF-002', 'admin1', 'hashed_pass_2', 'ADMIN', 1, '2026-04-07 23:57:25'),
(3, '2021-00001', 'santos_mc', 'hashed_pass_3', 'BORROWER', 1, '2026-04-07 23:57:25'),
