...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 13, 2026 at 02:58 PM
...
(5, 'Campus Job Fair', 'OTHER', '2026-05-05', 'Covered Court', 'FAC-003', 'STAFF-002', 'APPROVED', NULL),
...
CREATE TABLE IF NOT EXISTS `audit_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `idx_log_person` (`person_id`),
  KEY `idx_log_action` (`action`),
  KEY `idx_log_logged_at` (`logged_at`)
...
INSERT INTO `audit_log` (`log_id`, `person_id`, `username`, `action`, `entity`, `entity_id`, `details`, `logged_at`) VALUES
(1, 'STAFF-002', 'admin1', 'LOGIN', NULL, NULL, 'Successful login with role: ADMIN', '2026-05-13 22:07:13'),
(2, 'STAFF-002', 'admin1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:08:10'),
(3, 'STAFF-002', 'admin1', 'LOGIN', NULL, NULL, 'Successful login with role: ADMIN', '2026-05-13 22:08:16'),
(4, 'STAFF-002', 'admin1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:08:24'),
(5, 'STAFF-001', 'custodian1', 'LOGIN', NULL, NULL, 'Successful login with role: CUSTODIAN', '2026-05-13 22:08:31'),
(6, 'STAFF-001', 'custodian1', 'ADD_EQUIPMENT', 'equipment', 'EQ-0022', 'Added Laptop (EQUIPMENT) — barcode: EQ-0022', '2026-05-13 22:09:06'),
(7, 'STAFF-001', 'custodian1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:09:40'),
(8, '2021-00001', 'santos_mc', 'LOGIN', NULL, NULL, 'Successful login with role: BORROWER', '2026-05-13 22:09:48'),
(9, '2021-00001', 'santos_mc', 'SUBMIT_BORROW_REQUEST', 'borrow_request', '3', 'Requested: EQ-0022', '2026-05-13 22:10:24'),
(10, '2021-00001', 'santos_mc', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:10:27'),
(11, 'STAFF-001', 'custodian1', 'LOGIN', NULL, NULL, 'Successful login with role: CUSTODIAN', '2026-05-13 22:10:37'),
(12, 'STAFF-001', 'custodian1', 'APPROVE_BORROW_REQUEST', 'borrow_request', '3', 'Approved for Santos, Maria → TXN#10', '2026-05-13 22:11:05'),
(13, 'STAFF-001', 'custodian1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:11:10'),
(14, 'STAFF-002', 'admin1', 'LOGIN', NULL, NULL, 'Successful login with role: ADMIN', '2026-05-13 22:11:20'),
(15, 'STAFF-002', 'admin1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:14:37'),
(16, '2021-00001', 'santos_mc', 'LOGIN', NULL, NULL, 'Successful login with role: BORROWER', '2026-05-13 22:14:44'),
(17, 'STAFF-002', 'admin1', 'LOGIN', NULL, NULL, 'Successful login with role: ADMIN', '2026-05-13 22:30:16'),
(18, 'STAFF-002', 'admin1', 'CREATE_ACCOUNT', 'user_account', '8', 'Created \'noelle_p\' for 2021-00012 role=BORROWER', '2026-05-13 22:37:10'),
(19, 'STAFF-002', 'admin1', 'DEACTIVATE_ACCOUNT', 'user_account', '4', 'Account: reyes_jd', '2026-05-13 22:38:16'),
(20, 'STAFF-002', 'admin1', 'ACTIVATE_ACCOUNT', 'user_account', '4', 'Account: reyes_jd', '2026-05-13 22:38:17'),
(21, 'STAFF-002', 'admin1', 'DEACTIVATE_ACCOUNT', 'user_account', '8', 'Account: noelle_p', '2026-05-13 22:38:58'),
(22, 'STAFF-002', 'admin1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:38:59'),
(23, 'STAFF-002', 'admin1', 'LOGIN', NULL, NULL, 'Successful login with role: ADMIN', '2026-05-13 22:41:11'),
(24, 'STAFF-002', 'admin1', 'LOGOUT', NULL, NULL, 'User logged out', '2026-05-13 22:42:15'),
(25, 'STAFF-001', 'custodian1', 'LOGIN', NULL, NULL, 'Successful login with role: CUSTODIAN', '2026-05-13 22:42:20'),
(26, 'STAFF-001', 'custodian1', 'RUN_OVERDUE_CHECK', NULL, NULL, 'sp_mark_overdue_transactions executed', '2026-05-13 22:42:29');
...
CREATE TABLE IF NOT EXISTS `borrow_request` (
  `borrow_req_id` int NOT NULL AUTO_INCREMENT,
  `requester_id` varchar(20) NOT NULL,
  `item_barcodes` text NOT NULL,
  ...
  KEY `fk_breq_requester` (`requester_id`),
  KEY `fk_breq_reviewer` (`reviewed_by`)
...
INSERT INTO `borrow_request` (`borrow_req_id`, `requester_id`, `item_barcodes`, `purpose`, `needed_date`, `expected_return`, `status`, `reviewed_by`, `review_notes`, `created_at`, `transaction_id`) VALUES
(1, '2021-00004', 'EQ-0003,EQ-0009', 'Lab assignment — network topology demo', '2026-05-14', '2026-05-14', 'PENDING', NULL, NULL, '2026-05-13 21:03:16', NULL),
(2, '2021-00005', 'EQ-0008', 'Presentation practice session', '2026-05-15', '2026-05-15', 'PENDING', NULL, NULL, '2026-05-13 21:03:16', NULL),
(3, '2021-00001', 'EQ-0022', 'study', '2026-05-14', '2026-05-14', 'APPROVED', 'STAFF-001', 'take care approved!', '2026-05-13 22:10:24', 10);
...
(10, '2021-00001', 'STAFF-001', NULL, NULL, '2026-05-13 22:11:05', '2026-05-14', NULL, NULL, 'BORROWED');
...
('EQ-0022', 'Laptop', 'EQUIPMENT', 'Asus Rog', 'Zephrus', 'BORROWED', '2026-05-13', NULL);
...
INSERT INTO `person` (`person_id`, `last_name`, `first_name`, `middle_name`, `person_type`, `email`, `contact_no`, `status`) VALUES
('2021-00001', 'Santos', 'Maria', 'Cruz', 'STUDENT', 'santos.mc@slu.edu.ph', '09171234501', 'ACTIVE'),
('2021-00002', 'Reyes', 'John', 'dela', 'STUDENT', 'reyes.jd@slu.edu.ph', '09171234502', 'ACTIVE'),
('2021-00003', 'Garcia', 'Ana', 'Lopez', 'STUDENT', 'garcia.al@slu.edu.ph', '09171234503', 'ACTIVE'),
('2021-00004', 'Mendoza', 'Carlos', 'Bautista', 'STUDENT', 'mendoza.cb@slu.edu.ph', '09171234504', 'ACTIVE'),
('2021-00005', 'Flores', 'Liza', 'Tan', 'STUDENT', 'flores.lt@slu.edu.ph', '09171234505', 'ACTIVE'),
('2021-00006', 'Torres', 'Rico', 'Aquino', 'STUDENT', 'torres.ra@slu.edu.ph', '09171234506', 'ACTIVE'),
('2021-00007', 'Villanueva', 'Grace', 'Abad', 'STUDENT', 'villanueva.ga@slu.edu.ph', '09171234507', 'ACTIVE'),
('2021-00008', 'Cruz', 'Mark', 'Rivera', 'STUDENT', 'cruz.mr@slu.edu.ph', '09171234508', 'ACTIVE'),
('2021-00009', 'Ramos', 'Joy', 'Ocampo', 'STUDENT', 'ramos.jo@slu.edu.ph', '09171234509', 'ACTIVE'),
('2021-00010', 'Navarro', 'Ben', 'Salazar', 'STUDENT', 'navarro.bs@slu.edu.ph', '09171234510', 'ACTIVE'),
('2021-00011', 'Noelle', 'Panauyan', 'A', 'STUDENT', '1234567@slu.edu.ph', '09289988077', 'ACTIVE'),
('2021-00012', 'Noelle', 'Panauyan', 'A', 'STUDENT', '1234567@slu.edu.ph', '09289988077', 'ACTIVE'),
('FAC-001', 'Domingo', 'Rafael', 'Ignacio', 'FACULTY', 'domingo.ri@slu.edu.ph', '09181234501', 'ACTIVE'),
('FAC-002', 'Castillo', 'Elena', 'Morales', 'FACULTY', 'castillo.em@slu.edu.ph', '09181234502', 'ACTIVE'),
('FAC-003', 'Padilla', 'Jerome', 'Lim', 'FACULTY', 'padilla.jl@slu.edu.ph', '09181234503', 'ACTIVE'),
('STAFF-001', 'Hernandez', 'Miguel', 'Santos', 'STAFF', 'hernandez.ms@slu.edu.ph', '09191234501', 'ACTIVE'),
('STAFF-002', 'Aguilar', 'Rose', 'Valdez', 'STAFF', 'aguilar.rv@slu.edu.ph', '09191234502', 'ACTIVE');
...
(8, '2021-00012', 'noelle_p', '123', 'BORROWER', 0, '2026-05-13 22:37:10');
...
--
-- Stand-in structure for view `vw_pending_borrow_requests`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_pending_borrow_requests`;
CREATE TABLE IF NOT EXISTS `vw_pending_borrow_requests` (
`borrow_req_id` int
,`created_at` datetime
,`expected_return` date
,`item_barcodes` text
...
--
-- Stand-in structure for view `vw_persons_with_accounts`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_persons_with_accounts`;
CREATE TABLE IF NOT EXISTS `vw_persons_with_accounts` (
`account_active` tinyint(1)
,`account_created` varchar(10)
,`account_id` int
,`account_role` enum('ADMIN','CUSTODIAN','BORROWER')
,`contact_no` varchar(20)
,`email` varchar(100)
,`first_name` varchar(50)
,`last_name` varchar(50)
...
,`person_status` enum('ACTIVE','INACTIVE','SUSPENDED')
,`person_type` enum('STUDENT','FACULTY','STAFF')
,`username` varchar(50)
);
...
--
-- Structure for view `vw_pending_borrow_requests`
--
DROP TABLE IF EXISTS `vw_pending_borrow_requests`;

DROP VIEW IF EXISTS `vw_pending_borrow_requests`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_pending_borrow_requests`  AS SELECT `br`.`borrow_req_id` AS `borrow_req_id`, `br`.`requester_id` AS `requester_id`, concat(`p`.`last_name`,', ',`p`.`first_name`) AS `requester_name`, `p`.`person_type` AS `person_type`, `br`.`item_barcodes` AS `item_barcodes`, `br`.`purpose` AS `purpose`, `br`.`needed_date` AS `needed_date`, `br`.`expected_return` AS `expected_return`, `br`.`status` AS `status`, `br`.`created_at` AS `created_at` FROM (`borrow_request` `br` join `person` `p` on((`br`.`requester_id` = `p`.`person_id`))) WHERE (`br`.`status` = 'PENDING') ORDER BY `br`.`needed_date` ASC ;

-- --------------------------------------------------------

--
-- Structure for view `vw_persons_with_accounts`
--
DROP TABLE IF EXISTS `vw_persons_with_accounts`;

DROP VIEW IF EXISTS `vw_persons_with_accounts`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_persons_with_accounts`  AS SELECT `p`.`person_id` AS `person_id`, `p`.`last_name` AS `last_name`, `p`.`first_name` AS `first_name`, `p`.`middle_name` AS `middle_name`, `p`.`person_type` AS `person_type`, `p`.`email` AS `email`, `p`.`contact_no` AS `contact_no`, `p`.`status` AS `person_status`, `ua`.`account_id` AS `account_id`, `ua`.`username` AS `username`, `ua`.`role` AS `account_role`, `ua`.`is_active` AS `account_active`, date_format(`ua`.`created_at`,'%Y-%m-%d') AS `account_created` FROM (`person` `p` left join `user_account` `ua` on((`p`.`person_id` = `ua`.`person_id`))) ORDER BY `p`.`person_type` ASC, `p`.`last_name` ASC, `p`.`first_name` ASC ;
...
ALTER TABLE `borrow_request`
  ADD CONSTRAINT `fk_breq_requester` FOREIGN KEY (`requester_id`) REFERENCES `person` (`person_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_breq_reviewer` FOREIGN KEY (`reviewed_by`) REFERENCES `person` (`person_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- ================================================================
-- NEW PROCEDURES FOR REGISTRATION & ARCHIVING
-- ================================================================

-- Ensure the status column exists in the person table
ALTER TABLE person
MODIFY COLUMN status ENUM('ACTIVE', 'INACTIVE', 'SUSPENDED') NOT NULL DEFAULT 'ACTIVE';

DELIMITER $$
DROP PROCEDURE IF EXISTS `sp_register_new_user`$$ CREATE PROCEDURE `sp_register_new_user`(
    -- Person Details
    IN p_person_id VARCHAR(20),
    IN p_last_name VARCHAR(50),
    IN p_first_name VARCHAR(50),
    IN p_middle_name VARCHAR(50),
    IN p_type ENUM('STUDENT','FACULTY','STAFF'),
    IN p_email VARCHAR(100),
    IN p_contact VARCHAR(20),
    -- Account Details
    IN u_username VARCHAR(50),
    IN u_password VARCHAR(255),
    IN u_role ENUM('ADMIN','CUSTODIAN','BORROWER')
)
BEGIN
    ...
    START TRANSACTION;
        ...
        INSERT INTO person (
            ...
            person_type, email, contact_no, status
        ) VALUES (
            p_person_id, p_last_name, p_first_name, IFNULL(p_middle_name, ''),
            p_type, p_email, p_contact, 'ACTIVE'
        );

        -- 2. Create the User Account record
        INSERT INTO user_account (
            person_id, username, password_hash, role, is_active
        ) VALUES (
            p_person_id, u_username, u_password, u_role, 1
        );
    COMMIT;
END$$
DROP PROCEDURE IF EXISTS `sp_archive_person`$$ CREATE PROCEDURE `sp_archive_person`(IN p_person_id VARCHAR(20))
BEGIN
    -- Soft delete: marks person as INACTIVE and disables their login
    UPDATE person SET status = 'INACTIVE' WHERE person_id = p_person_id;
    UPDATE user_account SET is_active = 0 WHERE person_id = p_person_id;
END$$
DELIMITER ;
